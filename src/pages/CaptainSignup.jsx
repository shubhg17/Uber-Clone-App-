   ...
   return (
     <>
        <div className="p-7 h-screen flex flex-col justify-between ">
              <div>
                     <img className="w-14 mx-2 mb-8" src="https://imgs.search.brave.com/5qOrxTo-36NuK1RIyaWDLXjOoamQarfvHGwGx8NhyYw/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/bW9zLmNtcy5mdXR1/cmVjZG4ubmV0L0FW/U251azRFZ0VhWjJr/bXBnaVMyU2ouanBn" />
               ...
               {/* //onsubmit on form means ki form jabh submit hoga toh kya hoga  */}
                  <form onSubmit={(e)=> {
                   ...
                   <div className="flex gap-4 mb-2" >
                     ...
                     />
                     <Link to="/captainhome" className="bg-black flex items-center justify-center text-white w-full mt-4 rounded py-2 font-bold mb-4" >Create Account</Link>
