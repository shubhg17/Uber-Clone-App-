...
function FinishRiding() {
  return (
    <div className="fixed bottom-0 left-0 w-full bg-white z-50 p-4 rounded-t-2xl shadow-lg">
        ...
        <div className="flex justify-between border-b-2 mb-2 items-center">
          ...
          <div className="flex items-center gap-2">
            <img
              ...
              src="https://imgs.search.brave.com/PXTsyOhsdUquXQdSkb4CvFhEoY3FoHWod3zUEIH-8k4/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5nZXR0eWltYWdl/cy5jb20vaWQvMjE0/OTUzMDk5My9waG90/by9kaWdpdGFsLWh1/bWFuLWhlYWQtY29u/Y2VwdC1mb3ItYWkt/bWV0YXZlcnNlLWFu/ZC1mYWNpYWwtcmVj/b2duaXRpb24tdGVj/aG5vbG9neS5qcGc_/cz02MTJ4NjEyJnc9/MCZrPTIwJmM9SWR1/T1JKVXMxYzFzMG0y/U1hRQU5zSzhJVWh0/bHo4UUFwc0x4TllP/WXJYUT0"
            />
      ...
      {/* Pickup */}
      <div className="flex mb-5 border-b-2 gap-3">
      ...
      {/* Drop */}
      <div className="flex mb-5 border-b-2 items-center gap-3">
      ...
      {/* Button */}
      <Link to="/captainhome" className=" flex items-center justify-center text-lg text-white bg-green-600 w-full rounded-lg py-3 font-bold">
        Finish Ride
      </Link>
